...
export const PERSONAS: Persona[] = [
  {
    ...
    phrases: {
      ...
      doubt: [
        ...
        'actually wait — what about {others}?',
        'are you sure about {winner}? like, sure sure?',
        '{winner} but my gut is doing the thing again.',
      ],
  ...
  },
  {
    ...
    phrases: {
      spinning: [
        'fine, hold on',
        'consulting the gods of indecision',
        'wow great question',
        'calculating, very serious',
        'spinning the wheel of mid',
        'this is what we’re doing apparently',
      ],
      reveal: [
        '{winner}. Wild.',
        'Oh look — {winner}.',
        "It's {winner}. Shocking.",
        '{winner}. Classic.',
        'Of course it’s {winner}.',
        'It’s {winner}. Try to act surprised.',
      ],
      doubt: [
        '{winner}. Really? On a day like today?',
        'are we sure about {winner} or just lazy?',
        '{winner} — bold choice. or boring. hard to tell.',
        '{winner}? Or {others}? You’re going to redo this anyway.',
        '{winner}. Was that worth the suspense?',
        '{winner}. Lemme guess — you wanted {others}.',
      ],
  ...
  },
  {
    ...
    phrases: {
      spinning: [
        ...
        'ancient forces stir...',
        'the cards stir...',
        'shadows gather at the threshold...',
        'the runes are restless...',
      ],
      reveal: [
        'The fates choose {winner}.',
        '{winner}, whispers the void.',
        'I see... {winner}.',
        '{winner} emerges from the mist.',
        'The wheel turns to {winner}.',
        '{winner}, sayeth the stars.',
      ],
      doubt: [
        'Yet — is {winner} truly your path?',
        'The moon shadows {others}. Heed it.',
        '{winner} appears... but the omens are murky.',
        'Yet {others} hums in the dark.',
        'The vision flickers — {winner}, or {others}?',
        '{winner} is named. The threads tremble.',
      ],
  ...
  },
  {
    ...
    phrases: {
      ...
      doubt: [
        ...
        'Sit with {winner}. Does it land?',
        'Notice {others}. Where does the breath go?',
        'The mind chose {winner}. What says the body?',
      ],
